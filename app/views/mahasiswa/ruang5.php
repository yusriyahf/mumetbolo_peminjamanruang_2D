                        ...
                        <div class="col-lg-3 mb-4">
                            <div class="card text-white shadow <?= $bgClass; ?>">
                                <div class="card-body">
                                    ...
                                    <a href="#" class="btn btn-outline-light btn-sm tampilFormPinjam" data-toggle="modal" data-target="#formPinjamModal" data-id_ruang="<?= $ruang['id_ruang']; ?>" data-jadwal="<?= $ruang['id_jadwal']; ?>" data-tgl="<?= $data['tanggal']; ?>" data-nama_ruang="<?= $ruang['nama_ruang']; ?>">Pinjam</a>
                                </div>
                            </div>
                        </div>
                <?php endforeach;
