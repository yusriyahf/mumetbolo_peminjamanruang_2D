...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary mb-3">Tentukan Tanggal</h6>
            <a href="<?= BASEURL; ?>/file/tes.pdf" class="btn btn-primary btn-sm" target="_blank">Download File</a>
        </div>
        <div class="card-body">
            <form>
