      ...
      <div class="container">
         ...
         <div class="row text-center">
            ...
            <div class="card-body text-black">
               ...
               <p style='line-height:1.5;font-size:12;margin-left: 20;color:black;margin-right: 20;'>Sehubungan akan dilaksanakanya kegiatan <?= $data['proses']['tujuan']; ?> dari ......., 
                  kami mohon bantuan peminjaman ruangan <?= $data['proses']['id_ruang']; ?> Gedung Teknik Sipil Politeknik Negeri Malang beserta fasilitas yang ada didalamnya 
               ...
               <p style='padding-left: 30px;line-height:2;color:black;font-size:12;margin-left: 20;'>tempat&nbsp;&nbsp;&nbsp; :&nbsp; <?=$data['proses']['id_ruang']?> Gedung Sipil Politeknik Negeri Malang</p>
