    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <button type="button" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm tambahjadwal" data-toggle="modal" data-target="#formTambahJadwalModal">
                <i class="fa fa-plus fa-xs" aria-hidden="true"></i></i> <span style="margin-left: 5px;"></i> Tambah Data Jadwal
            </button>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered" id="dataTablejadwal" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Id Ruang</th>
                        ...
                        if (!empty($data['jd']) && is_array($data['jd'])) {
                            foreach ($data['jd'] as $jadwal) : ?>
                                <tr>
                                    ...
                                    <td><?= $jadwal['hari']; ?></td>
                                    <td>
                                        <a href="<?= BASEURL; ?>/admin/ubahJadwal/<?= $jadwal['id_jadwal']; ?>" class="btn btn-warning btn-split btn-sm tampilModalUbahJadwal" style="margin-right: 4px;" data-toggle="modal" data-target="#formEditModalJadwal" data-id="<?= $jadwal['id_jadwal']; ?>">
